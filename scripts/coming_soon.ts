...
$("/html") {
  $("./head") {
    ...
    insert_bottom("style", "body {background-color: #eee;} div {padding:10px;} #coming-soon {font-size: 30px;} #explanation {font-size: 15px;} #mw_desktop_link {text-align:center;display:block;}", data-mw_keep: "true")
  }
  $("./body") {
    $("./*") {
      remove()
